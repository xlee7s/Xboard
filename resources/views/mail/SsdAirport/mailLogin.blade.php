            ...
            <td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td style="font-size:14px;color:#333;padding:24px 40px 0 40px">
                                ...
                                <br />
                                <br />
                                官方网址：https://ssdayoo.com
                                <br />
                                进不去官网推荐使用夸克或谷歌浏览器！
                                <br />
                                <a href="https://ssdayoo.com">https://ssdayoo.com</a>
                            </td>
                        </tr>
                ...
                <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                        <tr>
                            <td style="padding:20px 40px;font-size:12px;color:#999;line-height:20px;background:#f7f7f7"><a href="https://ssdayoo.com" style="font-size:14px;color:#929292">返回{{$name}}</a></td>
                        </tr>
                        </tbody>
                    </table>
                </div></td>
